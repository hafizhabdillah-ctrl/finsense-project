        ...
        <div className='flex flex-col items-center'>
          ...
          <form onSubmit={handleSubmit} className='w-full'>
            <input
              ...
              className='w-full p-2 border rounded mb-4 focus:outline-none focus:ring-2 focus:text-sky-800 transition-colors'
              required
            />
            {message && (
            ...
            <button
              type='submit'
              disabled={loading}
              className='w-full bg-sky-950 text-white font-bold rounded-lg py-2 disabled:opacity-50'
            >
